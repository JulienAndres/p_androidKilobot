...
%les pricipazles propriété de ce domaine sont la robustesse et l ehcelle proposé. La robustesse peut etre obtenu 
...
\begin{figure}[h!]
	...
	(S) edge   [sloped,pos=0.7]node {Signal detecté} (R);
	\end{tikzpicture}
...
\begin{itemize}
	...
	\item [$-$]Le nombre de voisins actuels
	\item [$-$]Une entrée binaire associée à la présence ou non du bloc actif\\
\end{itemize}
Il y a deux sorties, correspondants aux moteurs gauche et droit de chaque Kilobot.
