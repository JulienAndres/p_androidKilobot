...
\begin{figure}[h]
	...
	\begin{minipage}[c]{.46\linewidth}
		...
		\caption{Nombre de robots mort en fonction du temps}
	\end{minipage}
\end{figure}
...
\begin{figure}[h]
	\begin{minipage}[c]{.46\linewidth}
		...
		\caption{Nombre de parent à l'origine des génomes des robots vivant}
	\end{minipage}
	\hfill%
	\begin{minipage}[c]{.46\linewidth}
		\centering
		\includegraphics[width=1.1\linewidth]{../../script_results/parent_origine_medea_zoom.png}
		\caption{Nombre de parent à l'origine des génomes des robots vivant(Zoom)}
	\end{minipage}
\end{figure}
