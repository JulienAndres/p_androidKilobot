...
# #plt.title("Agregation - Taille max/moy/min Cluster - methode probabiliste")
# #plt.show()
# #
# ##nb_clusters
# #ymoy = [9.75, 1.5, 9.25]
...
# #plt.title("Agregation - Nombre max/moy/min de clusters - methode probabiliste")
# #plt.show()
# #
...
# #plt.title("Agregation - Nombre max/moy/min de kilobots par cluster - methode probabiliste")
# #plt.show()
#
# #ymoy=[]
# #ymin=
...
# #plt.show()
#
# ## Analyse de la proba cluster_proba en fonction de la taille du cluster demande
# # avg_size
...
# plt.title("Agregation - Taille max/moy/min Cluster - Taille \"big\" cluster")
# plt.show()
#
# # nb_clusters
# ymoy = [1, 1, 1, 0.68]
...
# plt.ylabel("Nombre de clusters")
# plt.xlabel("Taille \"big\" cluster")
# plt.title("Agregation - Nombre max/moy/min de clusters - Taille \"big\" cluster")
# plt.show()
#
# # loss
...
# plt.ylabel("Nombre de Kilobot perdu")
# plt.xlabel("Taille \"big\" cluster")
# plt.title("Agregation - loss max/moy/min Kilobots - Taille \"big\" cluster")
# plt.show()
